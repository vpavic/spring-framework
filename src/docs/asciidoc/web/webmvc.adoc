...
`WebJarsResourceResolver` which is automatically registered. The resolver can re-write
URLs to include the version of the jar and can also match against incoming URLs without
